...
class Form extends React.Component {
    constructor(props) {
        ...
        this.setProgressCache = this.setProgressCache.bind(this);
    ...
    componentDidMount() {
        ...
        this.setState({ stop: stop, debug: document.getElementById('debug').innerHTML });        
    }
            ...
            <form >
                {this.state.formPartFilter === "0" &&
                    ...
                    <div className="button-menu-container">
                        ...
                        <a href="" className="button-left" title="" name="" onClick={this.clearStore} >Refresh Cache</a>
                        <a href="" className="button-left" title="" name="" onClick={this.setProgressCache} >Update Cache</a>
                        </div>
                    </div>
                }
                {this.state.formPartFilter === "1" &&
                    <div className="list-section">
                        ...
                        <div className="button-container">
                        <a href="" className="button-right" title="Next >>" name="2" onClick={(e) => this.handleFormSectionFilter(e)} > Next </a>                     </div>
                        <p className="styled">
                            <progress value={this.state.progress} max="100"></progress>
                            Step {this.state.formPartFilter} of 5 
                        </p>
                ...
                {this.state.formPartFilter === "2" &&
                    <div className="list-section">
                        ...
                        <h3>Student</h3>
                        <CheckBox2 key="Student" className="list-item" checked={this.state.stop.Person_Stopped.Is_Stud} value="Student" name="Student" onClick={(e) => this.updateBoolCheckBox(e, 'Person_Stopped', 'Is_Stud')} />
                ...
                {this.state.formPartFilter === "3" &&
                    <div className="list-section">
                        ...
                        <RadioButtonListSection  stateValue={this.state.stop.Person_Stopped.reasonForStop.details[0].reason} node="reasonForStop" node2="reason" node2b="details" itemList={trafficViolation} function={this.radioNestedRadioSelection} />
                                    ...
                                    <Tags tags={this.state.stop.Person_Stopped.reasonForStop.codes}
                            suggestions={this.state.codes.VC}
                            autofocus={false}
                            allowDeleteFromEmptyInput={false}
                                        placeholder='Add Vehicle Code'
                                        handleDelete={(e) => this.handleCodeDelete(e, 'reasonForStop', 'codes')}
                                        handleAddition={(e) => this.handleCodeAdd(e, 'reasonForStop', 'VC')}
                                        handleFilterSuggestions={this.handleFilterSuggestions} />
                                    <label className="list-item-nested"> Select 1 VC code (required)</label>
                            </div>
                        }
                        ...
                        <CheckBoxListSection type="CheckBox" stateValue={this.state.stop.Person_Stopped.reasonForStop.details} node="reasonForStop" node2="reason" node2b="details" itemList={reasonableSuspicion} function={this.radioNestedCheckBoxSelection} />
                                ...
                                <Tags tags={this.state.stop.Person_Stopped.reasonForStop.codes}
                            suggestions={this.state.codes.PC}
                            placeholder='Add Penal Code'
                            autofocus={false}
                            allowDeleteFromEmptyInput={false}
                                    handleDelete={(e) => this.handleCodeDelete(e, 'reasonForStop', 'codes')}
                                    handleAddition={(e) => this.handleCodeAdd(e, 'reasonForStop', 'PC')}
                                    handleFilterSuggestions={this.handleFilterSuggestions} />
                                <label className="list-item-nested"> Select 1 PC/HS code (required)</label>
                        ...
                        <CheckBox2 key="Warning (verbal or written)" className="list-item" checked={this.state.stop.Person_Stopped.resultOfStop.map(function (x) { return x.result; }).indexOf("Warning (verbal or written)") > -1} value="Warning (verbal or written)" name="Warning (verbal or written)" onClick={(e) => this.checkBoxSelection(e, 'resultOfStop', 'result', '', 2)} />
                            ...
                            <Tags tags={this.state.stop.Person_Stopped.resultOfStop[this.state.stop.Person_Stopped.resultOfStop.map(function (y) { return y.result }).indexOf("Warning (verbal or written)")].codes}
                                ...
                                allowDeleteFromEmptyInput={false}
                                    ...
                                    handleAddition={(e) => this.handleCodeAdd(e, '', 'VC', 'resultOfStop', 'result', 'Warning (verbal or written)')}
                                    handleFilterSuggestions={this.handleFilterSuggestions} />
                            <Tags tags={this.state.codeDummy}
                                suggestions={this.state.codes.PC}
                                placeholder='Add Penal/Health Code'
                                autofocus={false}
                                allowDeleteFromEmptyInput={false}
                                    handleDelete={(e) => this.handleCodeDelete(e, 'resultOfStop', '', 'result', 'Warning (verbal or written)')}
                                    handleAddition={(e) => this.handleCodeAdd(e, '', 'PC', 'resultOfStop', 'result', 'Warning (verbal or written)')}
                                    handleFilterSuggestions={this.handleFilterSuggestions} />
                                <label className="list-item-nested"> Select PC/HS/VC code (up to 5)</label>
                            </div>
                        }
                            ...
                            <div>
                                ...
                                allowDeleteFromEmptyInput={false}
                                    ...
                                    handleAddition={(e) => this.handleCodeAdd(e, '', 'VC', 'resultOfStop', 'result', 'Citation or infraction')}
                                    handleFilterSuggestions={this.handleFilterSuggestions} />
                                <Tags tags={this.state.codeDummy}
                                suggestions={this.state.codes.PC}
                                placeholder='Add Penal/Health Code'
                                ...
                                allowDeleteFromEmptyInput={false}
                                    handleDelete={(e) => this.handleCodeDelete(e, 'resultOfStop', '', 'result', 'Citation or infraction')}
                                    handleAddition={(e) => this.handleCodeAdd(e, '', 'PC', 'resultOfStop', 'result', 'Citation or infraction')}
                                    handleFilterSuggestions={this.handleFilterSuggestions} />
                                <label className="list-item-nested"> Select  PC/HS/VC code (up to 5)</label>
                            </div>
                                }
                            ...
                            <Tags tags={this.state.stop.Person_Stopped.resultOfStop[this.state.stop.Person_Stopped.resultOfStop.map(function (y) { return y.result }).indexOf("In-field cite and release")].codes}
                                ...
                                allowDeleteFromEmptyInput={false}
                                        ...
                                        handleAddition={(e) => this.handleCodeAdd(e, '', 'VC', 'resultOfStop', 'result', 'In-field cite and release')}
                                        handleFilterSuggestions={this.handleFilterSuggestions} />
                            <Tags tags={this.state.stop.codeDummy}
                                suggestions={this.state.codes.PC}
                                placeholder='Add Penal/Health Code'
                                autofocus={false}
                                allowDeleteFromEmptyInput={false}
                                handleDelete={(e) => this.handleCodeDelete(e, 'resultOfStop', '', 'result', 'In-field cite and release')}
                                handleAddition={(e) => this.handleCodeAdd(e, '', 'PC', 'resultOfStop', 'result', 'In-field cite and release')}
                                handleFilterSuggestions={this.handleFilterSuggestions} />
                            <label className="list-item-nested"> Select  PC/HS/VC code (up to 5)</label>
                            </div>
                                }
                            ...
                            <Tags tags={this.state.stop.Person_Stopped.resultOfStop[this.state.stop.Person_Stopped.resultOfStop.map(function (y) { return y.result }).indexOf("Custodial Arrest without warrant")].codes}
                                ...
                                allowDeleteFromEmptyInput={false}
                                        ...
                                        handleAddition={(e) => this.handleCodeAdd(e, '', 'VC', 'resultOfStop', 'result', 'Custodial Arrest without warrant')}
                                        handleFilterSuggestions={this.handleFilterSuggestions} />
                            <Tags tags={this.state.stop.codeDummy}
                                suggestions={this.state.codes.PC}
                                placeholder='Add Penal/Health Code'
                                ...
                                allowDeleteFromEmptyInput={false}
                                handleDelete={(e) => this.handleCodeDelete(e, 'resultOfStop', '', 'result', 'Custodial Arrest without warrant')}
                                handleAddition={(e) => this.handleCodeAdd(e, '', 'PC', 'resultOfStop', 'result', 'Custodial Arrest without warrant')}
                                handleFilterSuggestions={this.handleFilterSuggestions} />
                            <label className="list-item-nested">Select  PC/HS/VC code (up to 5)</label>
                            </div>
                                }
                ...
                {this.state.formPartFilter === "5" &&
                    <div className="list-section">
                        ...
                        <a href="" className="button-left" title="<< Back" name="4" onClick={(e) => this.handleFormSectionFilter(e)} > Back </a>
                         ...
                         <a href="" className="button-right" title="Next >>" value="Submit" name="Submit" onClick={this.handleSubmit} > Submit </a>
                        </div>
                        <p className="styled">
